...
$stm = $_db->prepare("
    ...
    FROM fine f
    JOIN borrowing b
        ON f.borrowing_id = b.borrowing_id
    JOIN book bk
    ...
    <div class="fines-stats">
        ...
        <div class="stat-card">
            ...
            <span class="stat-number">
                RM <?= number_format($total_fines, 2) ?>
            </span>
    ...
    <div class="table-container">
        ...
        <?php if (empty($fines)): ?>
            ...
            >
                ...
                <p>
                    Keep up the good work returning books on time.
                </p>
